...
function hasher(password, salt, configuration) {
  const hash2 = (0, import_node_crypto.createHmac)(configuration.hashAlgorithm, salt);
...
function generateSalt(rounds = DEFAULT_SALT_ROUNDS) {
  ...
  const salt = (0, import_node_crypto.randomBytes)(Math.ceil(rounds / 2)).toString("hex");
